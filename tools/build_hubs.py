...
HUBS = [
    {
        ...
        "title": "Беременность и роды: подготовка, сопровождение доулы и восстановление",
        ...
        "lead": "Самое важное время — и важно, кто рядом. Здесь собрано всё, что поможет пройти путь спокойно: доула, которую я знаю лично, и статьи журнала без запугивания и громких обещаний.",
        "c": "#35b6ff", "c2": "#d100ff",
        "services": [
    ...
    },
    {
        ...
        "title": "Тело и восстановление: массаж на дому в Кисловодске и как вернуть силы",
        ...
        "lead": "Забота о теле — основа всего остального. Мастер, которому я доверяю, и простые способы вернуть энергию без крайностей.",
        "c": "#9b6cff", "c2": "#00b4ff",
        "services": [
    ...
    {
        "slug": "retrity-i-kmv",
        "title": "Ретриты и Кавминводы: уединение, экскурсии и места силы Кавказа",
...
def build():
    ...
    for hub in HUBS:
        ...
        page = TEMPLATE.format(
            ...
            footer=footer, tail=tail, n=sum(len(i) for _, i in groups))
...
{podbor}
  ...
  <section class="tlg-sec" id="stati" aria-labelledby="s-h">
    <div class="tlg-head rv"><span class="tlg-kicker">Журнал «Компас»</span><h2 id="s-h">Статьи по теме</h2><p>{n} материалов простым языком — без запугивания и обещаний чудес.</p></div>
{lists}
    <p class="note">{note}</p>
  </section>
